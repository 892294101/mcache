...
type reader interface {
	...
	readFrom(aa *mmap.File, offset uint64, index int) int
}
...
func (br *bytesReader) readFrom(aa *mmap.File, offset uint64, index int) int {
...
func (sr *stringReader) readFrom(aa *mmap.File, offset uint64, index int) int {
